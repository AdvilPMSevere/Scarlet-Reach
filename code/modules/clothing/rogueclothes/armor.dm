...
/obj/item/clothing/suit/roguetown/armor/leather/trophyfur
	...
	prevent_crits = list(BCLASS_STAB, BCLASS_BLUNT, BCLASS_SMASH, BCLASS_PICK,)
	max_integrity = 300
	sellprice = 100
...
/obj/item/clothing/suit/roguetown/armor/plate/elven_plate
	...
	prevent_crits = list(BCLASS_BLUNT, BCLASS_PICK, BCLASS_SMASH)
	body_parts_covered = COVERAGE_FULL
...
/obj/item/clothing/suit/roguetown/armor/captain
	...
	body_parts_covered = COVERAGE_ALL_BUT_LEGS
	max_integrity = 500
	prevent_crits = list(BCLASS_BLUNT, BCLASS_PICK, BCLASS_SMASH, BCLASS_CUT, BCLASS_CHOP)
